...
namespace Account_Management.Transaction
{
    public partial class FrmSaleReturn : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            DataTable DTab_Sale_Return = objSaleInvoice.Sale_Return_Print_GetData(Val.ToInt64(lblMode.Tag));
            ...
            FrmReportViewer.ShowForm("Bill_Detail", 120, FrmReportViewer.ReportFolder.SALE_RETURN);
