...
namespace Account_Management.Report.Barcode_Print
{
    ...
    public class BarcodePrint
    {
        ...
        public class Stock_Pkt
        {
            ...
            public bool RBar = false;
            public Decimal Balance_Pcs = 0;

            public Stock_Pkt(string pStrItem, string pIntColor, string pStrSize, Int64 pIntStockId, Decimal pBalancePcs, bool pBoolRBar)
            {
        ...
        public void Stock_AddPkt(string pStrItem, string pIntColor, string pStrSize, Int64 pIntStockId, decimal pBalancePcs, bool pBoolRBar)
        {
            this._Pkt.Add(new BarcodePrint.Stock_Pkt(pStrItem, pIntColor, pStrSize, pIntStockId, pBalancePcs, pBoolRBar));
        }

        public void Stock_PrintTSC(Int64 Barcode_Count)
        {
