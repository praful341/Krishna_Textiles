    ...
    public class PurchaseReturn
    {
        ...
        public PurchaseReturn_Property Save(PurchaseReturn_Property pClsProperty, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            try
            {
                ...
                Request.CommandText = BLL.TPV.SProc.TRN_PurchaseReturn_Save;
        ...
        public int Save_Detail(PurchaseReturn_Property pClsProperty, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            try
            {
                ...
                RequestDetails.AddParams("@purchase_return_id", pClsProperty.purchase_return_id, DbType.Int64);
                ...
                RequestDetails.CommandText = BLL.TPV.SProc.TRN_PurchaseReturn_Detail_Save;
        ...
        public int Delete(PurchaseReturn_Property pClsProperty, Int32 flag, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            try
            {
                ...
                RequestDetails.CommandText = BLL.TPV.SProc.TRN_PurchaseReturn_Delete;
                RequestDetails.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable GetData(string p_dtpFromDate, string p_dtpToDate, Int64 voucher_no, int Ledger_ID)
        {
            ...
            Request Request = new Request();
            Request.CommandText = BLL.TPV.SProc.TRN_PurchaseReturn_GetData;
            Request.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable GetDataDetails(int p_numID)
        {
            ...
            {
                Request Request = new Request();
                Request.CommandText = BLL.TPV.SProc.TRN_PurchaseReturn_GetDetailsData;
                Request.CommandType = CommandType.StoredProcedure;
                Request.AddParams("@p_numPurchaseReturn_ID", p_numID, DbType.Int64);
