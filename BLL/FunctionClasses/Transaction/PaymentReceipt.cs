...
namespace BLL.FunctionClasses.Account
{
    public class PaymentReceipt
    {
        ...
        public DataTable Sale_Invoice_Search_GetData(Int64 Ledger_ID, string Order_No)
        {
            ...
            Request.AddParams("@order_no", Order_No, DbType.String);
        ...
        public DataSet Account_Ledger_GetData(Int64 Union_ID)
        {
            ...
            Request Request = new Request();
            Request.CommandText = BLL.TPV.SProc.TRN_Payment_FillData;
            Request.CommandType = CommandType.StoredProcedure;
