    ...
    public class SaleReturn
    {
        ...
        public SaleReturn_Property Save(SaleReturn_Property pClsProperty, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            try
            {
                ...
                Request.CommandText = BLL.TPV.SProc.TRN_SaleReturn_Save;
        ...
        public int Save_Detail(SaleReturn_Property pClsProperty, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            try
            {
                ...
                RequestDetails.AddParams("@return_detail_id", pClsProperty.return_detail_id, DbType.Int64);
                RequestDetails.AddParams("@sale_return_id", pClsProperty.sale_return_id, DbType.Int64);
                ...
                RequestDetails.CommandText = BLL.TPV.SProc.TRN_SaleReturn_Details_Save;
        ...
        public int Delete(SaleReturn_Property pClsProperty, Int32 flag, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            try
            {
                Request Request = new Request();
                ...
                RequestDetails.CommandText = BLL.TPV.SProc.TRN_SaleReturn_Delete;
                RequestDetails.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable GetDataDetails(int p_numID)
        {
            ...
            try
            {
                ...
                Request.CommandType = CommandType.StoredProcedure;
                Request.AddParams("@p_numSale_Return_ID", p_numID, DbType.Int64);
