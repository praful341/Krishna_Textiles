    ...
    public class LedgerMaster
    {
        ...
        public int Save(Ledger_MasterProperty pClsProperty)
        {
            ...
            try
            {
                ...
                Request.AddParams("@opening_type", pClsProperty.opening_type, DbType.String);
        ...
        public DataTable CashBank_WithoutLedger_GetData(int active = 0)
        {
            DataTable DTab = new DataTable();
            Request Request = new Request();
            ...
            Request.CommandText = BLL.TPV.SProc.MST_CashBank_Without_Ledger_GetData;
            Request.CommandType = CommandType.StoredProcedure;
